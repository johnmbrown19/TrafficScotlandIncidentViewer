...
public class RoadworksActivity extends AppCompatActivity {
    ...
    //TODO: array list each for roadworks and planned roadworks
    private ArrayList<Roadwork> roadworks;

    private RecyclerView recyclerView;
    private RoadworksRecyclerViewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roadworks); //change this to activity_roadworks
        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        adapter = new RoadworksRecyclerViewAdapter(this);
        ...
        incidentsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RoadworksActivity.this, MainActivity.class);
        ...
        plannedRoadworksButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RoadworksActivity.this, PlannedRoadworksActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void filter(String text) {
        ...
        for (Roadwork item : roadworks) {
            ...
            if (item.getTitle().toLowerCase().contains(text.toLowerCase()) ||
                ...
                filteredRoadworks.add(item);
            }
        }
        if (filteredRoadworks.isEmpty()) {
            ...
            adapter.filterList(filteredRoadworks);
        }
    }
    ...
    private class GetDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            adapter.setRoadworks(roadworks);
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if (parser.getName().equals("item")) {
                    ...
                    Roadwork roadwork = new Roadwork(title, description, link, georss, pubDate);
