...
public class PlannedRoadworksActivity extends AppCompatActivity {
    private static final String TAG = "PlannedRoadworksActivity";

    private ArrayList<PlannedRoadwork> plannedRoadworks;

    private RecyclerView recyclerView;
    private PlannedRoadworksRecyclerViewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planned_roadworks); //change this to activity_roadworks
        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);
        adapter = new PlannedRoadworksRecyclerViewAdapter(this);
        ...
        incidentsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PlannedRoadworksActivity.this, MainActivity.class);
        ...
        roadworksButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PlannedRoadworksActivity.this, RoadworksActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void filter(String text) {
        ...
        for (PlannedRoadwork item : plannedRoadworks) {
            ...
            if (item.getTitle().toLowerCase().contains(text.toLowerCase()) ||
                ...
                filteredPlannedRoadworks.add(item);
            }
        }
        if (filteredPlannedRoadworks.isEmpty()) {
            ...
            adapter.filterList(filteredPlannedRoadworks);
        }
    }
    ...
    private class GetDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            adapter.setPlannedRoadworks(plannedRoadworks);
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if (parser.getName().equals("item")) {
                    ...
                    PlannedRoadwork plannedRoadwork = new PlannedRoadwork(title, description, link, georss, pubDate);
    ...
    //TODO: Copy this function to getRoadworkInputStream & getPlannedRoadworkInputStream
